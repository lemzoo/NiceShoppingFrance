...
<html>
    ...
    <body>
    	...
    	<form method="post" action="addUser/traitement.php">
 
		   <fieldset>
		       	<legend id= "titre_legende">Votre identité</legend> <!-- Titre du fieldset --> 
		       	
		       	<!-- Choix de la civilité -->
		       	<select name="civilite" autofocus="autofocus" autofocus="autofocus" required="requierd">
		       	...
		       	<input type="text" name="nom" id="nom" autofocus="autofocus" required="requierd" value="DUPONT" /><br/>

		       	<label for="prenom">Votre prenom : </label>
		       	<input type="text" name="prenom" id="prenom" autofocus="autofocus" required="requierd" value="Pierre" /><br/>

		       	<label for="dateNaissance">Votre date de naissance : </label>
		       	<input type="date" name="dateNaissance" id="dateNaissance" autofocus="autofocus" required="requierd"/><br/>

		       	<label for="numeroTelephone">Votre numéro de téléphone : </label>
		       	<input type="tel" name="numeroTelephone" id="numeroTelephone" autofocus="autofocus" required="requierd" value="+33 6 51 58 75 08" /><br/>
		   	</fieldset>
		   	...
		   	<fieldset>
		       	...
		       	<input type="text" name="numeroNomVoie" id="numeroNomVoie" autofocus="autofocus" required="requierd" value="1 Avenue Charles de Gaulle" /><br/>

		       	<label for="complementAdresse">Complément adresse : </label>
		       	<input type="text" name="complementAdresse" id="complementAdresse" autofocus="autofocus" value="Ex : Chez M. DUPONT, Appart 46" /><br/>

		       	<label for="codePostale">Code Postale : </label>
		       	<input type="int" name="codePostale" id="codePostale" autofocus="autofocus" required="requierd" value="75010" /><br/>

		       	<label for="ville">Ville : </label>
		       	<input type="text" name="ville" id="ville" autofocus="autofocus" required="requierd"  value="Paris" /><br/>

		       	<label for="region">Region : </label>
		       	<input type="text" name="region" id="region" autofocus="autofocus" value="Ile de France" /><br/>

		       	<label for="pays">Pays : </label>
		       	<input type="text" name="pays" id="pays" autofocus="autofocus" required="requierd" value="France" /><br/>
		   	</fieldset>
		   	...
		   	<fieldset>
		       	...
		       	<input type="email" name="emailFirst" id="emailFirst" autofocus="autofocus" required="requierd"/><br/>
		       	
		       	<label for="emailSecond">Confirmer votre adresse mail</label>
		       	<input type="email" name="emailSecond" id="emailSecond" autofocus="autofocus" required="requierd"/><br/>
		   	...
		   	<!-- Votre Role -->
		   	<fieldset>
		       	<legend id= "titre_legende">Le role de l'utilisateur </legend> <!-- Titre du fieldset --> 
